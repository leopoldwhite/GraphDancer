...
class LLMGenerationManager:
    ...
    def execute_predictions(self, predictions: List[str], pad_token: str, active_mask=None, do_search=True) -> List[str]:
        ...
        Returns a tuple of (next_obs, dones, valid_action, is_search)
        """
            ...
            if not active:
                ...
                if action == 'answer':
                    ...
                    next_obs.append(
                        ...
                        f'If I want to give the final answer, I should put the answer between <answer> and </answer>. Let me try again.\n'
                    )
                    dones.append(0)
                    valid_action.append(0)
                    valid_action.append(0)
    ...
    def batch_search(self, queries: List[str] = None) -> str:
        """Batchified search for queries. Returns concatenated string results."""
